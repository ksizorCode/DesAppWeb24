...
$sql = "SELECT DISTINCT fechainicio, titulo FROM eventos WHERE fechainicio >= '2024-01-01' AND fechafin <= '2024-12-31' ORDER BY fechainicio ASC;";
...
for ($month = 1; $month <= 12; $month++) {
    ...
    for ($day = 1; $day <= $numDays; $day++) {
        ...
        // Imprimir el número del día --------- CADA DÍA -----
            ...
            echo "<td class='$fecha ".hoyhayalgo($fecha, $datos)."'>";
